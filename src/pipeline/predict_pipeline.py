...
class PredictionPipeline:
    ...
    def predict(self,features):
        ...
        try:
            ...
            preprocessor =self.utils.load-object(file_path=self.prediction_pipeline_config.preprocessor_path)        
    ...
    def get_predicted_dataframe(self,input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            predictin_column_name: str = TARGET_COLUMN
            ...
            input_dataframe[predictin_column_name] = [pred for pred in predictions ]
            
            target_column_mapping = {0: "bad",1:"good"}
            
            input_dataframe[predictin_column_name] = input_dataframe[predictin_column_name].map(target_column_mapping)
