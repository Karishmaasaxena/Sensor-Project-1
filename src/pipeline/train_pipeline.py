...
class TrainingPipeline:
    ...
    def  start_data_transformation(self,feature_store_file_path):
        try:
            ...
            train_arr,test_arr, preproccer, preprocessor_path= data_transformation.initiate_data_transformation()
            return train_arr,test_arr,preproccer,preprocessor_path
    ...
    def run_pipeline(self):
        try:
            ...
            print("training completed. Trained model acore:", r2_square)
